    ...
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 max-w-7xl mx-auto gap-6 p-5">
            ...
            <div className="flex gap-4 flex-wrap">
              {[FaFacebookF, FaTwitter, FaPinterestP, FaLinkedinIn].map(
                (Icon, idx) => (
                  <Icon
                    key={idx}
                    className="bg-gray-300 w-10 h-10 rounded-full p-2 hover:bg-orange-500 hover:text-white transition-all duration-300 hover:rotate-360"
                  />
                )
              )}
            </div>
        ...
        <div className="bg-gray-100 p-5">
          ...
          <form>
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="w-full relative">
                  <div
                    ...
                    className="cursor-pointer text-gray-500 py-2 px-3 rounded bg-white flex justify-between items-center"
                  >
                    <span>{selected}</span>
            ...
            <button className="flex items-center gap-2 bg-[#eb3300] text-white font-bold text-sm md:text-[16px] p-2 md:p-4">
              SUBMIT NOW
              <FaArrowRight />
            </button>
          </form>
      ...
      <div className="w-8/12 mx-auto">
        <iframe
          ...
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3557.9415056897888!2d75.72937887489472!3d26.905351460408006!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x396db3fe5bb55f51%3A0x28ef04348dea4ee9!2sSudo%20Techlabs!5e0!3m2!1sen!2sin!4v1752496436205!5m2!1sen!2sin"
          loading="lazy"
        ></iframe>
      </div>
    </>
